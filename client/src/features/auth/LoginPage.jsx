    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-color)] p-4 relative overflow-hidden">
      ...
      <div className="glass-card w-full max-w-md p-8 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-secondary)] mt-2">Welcome back to your Productivity OS</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-[var(--text-secondary)]">
          Don't have an account? <Link to="/register" className="text-[var(--primary-color)] font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
